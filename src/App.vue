    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-5">
          ...
          <div class="human-icon-container text-center" :class="{ 'stop-animation': actionResults }">
        ...
        <div class="col-5">
          ...
          <div class="computer-icon-container text-center" :class="{ 'stop-animation': actionResults }">
      ...
      <div class="row">
        <div class="col">
          <button type="button" class="btn btn-light btn-lg btn-block" data-toggle="button" aria-pressed="false" @click="onAction('hand-paper')">
            Paper
          </button>
        </div>

        <div class="col">
          <button type="button" class="btn btn-secondary btn-lg btn-block" data-toggle="button" aria-pressed="false" @click="onAction('hand-rock')">
            Rock
          </button>
        </div>

        <div class="col">
          <button type="button" class="btn btn-warning btn-lg btn-block" data-toggle="button" aria-pressed="false" @click="onAction('hand-scissors')">
            Scissors
          </button>
        </div>

        <div class="col">
          <button type="button" class="btn btn-success btn-lg btn-block" data-toggle="button" aria-pressed="false" @click="onAction('hand-lizard')">
            Lizard
          </button>
        </div>

        <div class="col">
          <button type="button" class="btn btn-info btn-lg btn-block" data-toggle="button" aria-pressed="false" @click="onAction('hand-spock')">
            Spock
          </button>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col">
          ...
          <button class="btn-link btn-sm" @click="infoButton()">Information</button>
        </div>
      ...
      <InfoModal v-if="showInfoModal" @closeWindow="showInfoModal = false"></InfoModal>
